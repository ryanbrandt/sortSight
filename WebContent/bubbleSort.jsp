...
<head>
	<meta charset="utf-8">
 	...
 	<title>BubbleSort Algorithm</title>
</head>
<!-- JSP Content -->
<%
/* manual summary statistics */
	...
	try{
		...
		ResultSet mergeSortData = st.executeQuery("select * from trials where 'BubbleSort' in(method)");
...
<div class="container-fluid text-center">    
  	<div class="row content">
		...
		<div class="col-sm-8 text-left">
			...
			<h1>The BubbleSort Algorithm</h1>
			<p>
				An algorithm here!
			</p>
		</div>
